...
public class Recv4 {
	...
	public static void main(String[] args) throws Exception {
		...
		String recv4 = "#.item.*";
		//绑定队列到交换机
		channel.queueBind(QUEUE_NAME,EXCHANGE_NAME, recv4);
		
		System.out.println("44444 [*] Waiting for messages. To exit press CTRL+C");
        ...
        Consumer consumer = new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope,
                ...
                System.out.println("44444 [x] Received '" + message + "'");
            }
        };
